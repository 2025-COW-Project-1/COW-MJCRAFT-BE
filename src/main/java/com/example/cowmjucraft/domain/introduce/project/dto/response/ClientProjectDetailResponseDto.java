...
@Schema(description = "프로젝트 상세 공개 응답 DTO")
public record ClientProjectDetailResponseDto(
        ...
        @Schema(description = "상세 이미지 mediaId 목록", example = "[11, 12, 13]")
    ...
    public static ClientProjectDetailResponseDto from(Project project, List<Long> imageMediaIds) {
        return new ClientProjectDetailResponseDto(
                project.getId(),
                project.getTitle(),
                project.getSummary(),
